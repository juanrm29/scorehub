...
export function Sidebar() {
  ...
  const sidebarContent = (
    <>
      ...
      <nav className="flex-1 p-3 space-y-0.5 overflow-y-auto">
        <p className="text-[9px] text-[#444] uppercase tracking-[0.15em] font-bold px-3 py-2 mt-1">Navigation</p>
      ...
      <div className="p-3 border-t border-white/[0.04]">
        ...
        >
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] font-semibold text-cyan-400 uppercase tracking-wider">System Status</span>
          </div>
          <p className="text-[10px] text-[#555]">All systems operational</p>
  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex fixed left-0 top-0 h-screen w-72 glass-strong flex-col z-50 overflow-hidden">
        {sidebarContent}
      </aside>
